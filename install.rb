...
if Dir.exist? INSTALL_LOC
  puts "Warning: ~/kanka already exists!"
end

puts "We will install to ~/kanka and put an alias in your .<shell>rc. Hit <enter> or 'y' if this is okay."
STDOUT.flush
CONTINUE = ask "> "
if CONTINUE == "" || CONTINUE == "y"
    ...
    print "Writing an alias called `kanka` to " + SHELLRC + "\n"
    open(SHELLRC, 'a') do |f|
      f.puts "\n"
